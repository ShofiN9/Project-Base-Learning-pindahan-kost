...
<body class="w-full min-h-screen bg-gradient-to-tl from-red-950 to-red-600">
                    ...
                    <div class="px-10 flex flex-row">
                        ...
                        <nav class="flex ps-80 items-center justify-end">
                            <ul class="flex">
                                ...
                                <li class="group">
                                    <a href="/admin/testimoni_admin" class="text-sm text-white py-5 px-6 flex group-hover:text-red-500">TESTIMONI</a>
                                </li>
                            </ul>
                        </nav>
        ...
        <div class="my-8 ml-10 items-center px-4">
            <h1 class="text-white pt-5 font-semibold text-4xl">Welcome Admin PICKOST</h1>
        </div>
        <div class="container bg-white m-auto p-10">
            <div class="flex justify-between items-center">
                <h1 class="mt-0 ml-5 font-semibold text-2xl text-red-600">Data User</h1>
            </div>  
            <div class="rounded-lg border border-gray-200 mt-4">
                <div class="overflow-x-auto rounded-t-lg">
                    ...
                    <thead class="bg-gray-200 border-b-2 border-gray-300">                        
                        ...
                        <th class="px-4 py-2 font-semibold text-gray-900 tracking-wide text-left">Email</th>
                        <th class="px-4 py-2 font-semibold text-gray-900 tracking-wide text-left">Alamat</th>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="px-4 py-2 text-gray-700">{{ $user->alamat }}</td>
                        <td class="py-2 px-4">
                            <form action="{{ route('destroy.admin', $user->id) }}" method="POST" onsubmit="return confirm('Apakah anda yakin ingin menghapus user ini?')">
                                @csrf
                                @method('DELETE')
